...
${GIZA}/mgiza -s ${prefix}/${name_1}.vcb -t  ${prefix}/${name_2}.vcb -c  ${prefix}/${name_1}_${name_2}.snt -coocurrencefile  ${prefix}/${name_1}_${name_2}.cooc -o ${prefix}/${name_1}_${name_2} -hmmdumpfrequency 1

echo "Getting alignments"

python - ${prefix}/${name_1}.vcb ${prefix}/${name_2}.vcb ${prefix}/*.thmm.5 <<EOF > ${prefix}/alignments
import sys
src = {}
